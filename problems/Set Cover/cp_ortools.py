...
class VarArrayAndObjectiveSolutionPrinter(cp_model.CpSolverSolutionCallback):
    ...
    def on_solution_callback(self):
        ...
        print("Interval using %.4f"  % interval_used,         end = ', ')
        print("Accu using %.4f"      % time_used,             end = ', ')
        print("Solution %i"          % self.__solution_count, end = ', ')
...
# python cp_ortools.py ./data/sc_157_0